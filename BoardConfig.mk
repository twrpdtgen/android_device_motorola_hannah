...
#BOARD_RECOVERYIMAGE_PARTITION_SIZE := 21993472 # This is the maximum known partition size, but it can be higher, so we just omit it
...
TARGET_KERNEL_SOURCE := kernel/motorola/hannah
